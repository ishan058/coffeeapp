  ...
  void addToCart() async {
    if (quantity > 0) {
      ...
      await firebaseFirestore.collection('cart').doc().set(
        {"name": widget.coffee.name, "image": widget.coffee.imagePath, "price": (quantity * int.parse(widget.coffee.price)).toString()},
      );
              ...
              Column(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: Colors.grey, fontSize: 20, letterSpacing: 2.3),
                  ),
