                  ...
                  image == null
                      ? Container(
                          ...
                          decoration: BoxDecoration(
                              color: Colors.cyan[300], image: DecorationImage(image: AssetImage('lib/images/black.png'), fit: BoxFit.contain)),
                        )
                      : Container(
                          color: Colors.grey,
                          width: MediaQuery.of(context).size.width,
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  await firebaseFirestore.collection('coffee').doc(name.text).set(
                    {"name": name.text, "image": '', "price": price.text},
                  );
                  ...
                  var items = firebaseFirestore.collection('coffee').doc(name.text);
